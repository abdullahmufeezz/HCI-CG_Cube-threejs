# HCI-CG Cube Three.js

A React-based interactive 3D cube visualization project built with **Three.js**. This project combines Human-Computer Interaction (HCI) principles with Computer Graphics (CG) to create a responsive and engaging 3D experience.
...
- **Three.js Graphics**: Leverages Three.js for 3D rendering
- **Responsive Design**: Adapts to different screen sizes
- **HCI Focus**: User-friendly interface with intuitive controls
